...
public class FlattenExprTransformerTest {
	...
	@Test
		public void testFlattenExpr_mult_axb_cxd() {
			// given
			...
			Expr flatternExpandedExpr = FlattenExprTransformer.flattenExpr(expandedExpr); // = (axcx) + (axd) + (bcx) + bd
	...
	@Test
		public void testFlattenExpr_mult_axbyc_dxeyf() {
			// given
